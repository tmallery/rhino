...
public class SortingTest {
    ...
    private void quickSort(Object[] expected)
    {
        Object[] after = Arrays.copyOf(expected, expected.length);
        Sorting.quicksort(after, new IntComparator());
        Arrays.sort(expected, new IntComparator());
        assertArrayEquals(expected, after);
    }
    ...
    {
        quickSort(forwardArray(100));
        quickSort(reverseArray(100));
        quickSort(randomArray(100));
        quickSort(sameArray(100));
        quickSort(new Object[] {});
        quickSort(randomArray(10000));
    }
    ...
    private void heapSort(Object[] expected)
    {
        Object[] after = Arrays.copyOf(expected, expected.length);
        Sorting.heapsort(after, new IntComparator());
        Arrays.sort(expected, new IntComparator());
        assertArrayEquals(expected, after);
    }
    ...
    {
        heapSort(randomArray(10));
        heapSort(forwardArray(100));
        heapSort(reverseArray(100));
        heapSort(randomArray(100));
        heapSort(sameArray(100));
        heapSort(new Object[] {});
        heapSort(randomArray(10000));
    }
    ...
    @Test
    public void testBenchInsertion2Random()
    {
        Object[] a = Arrays.copyOf(bigRandom, bigRandom.length);
        Sorting.insertionSort2(a, 0, a.length -1, new IntComparator());
    }
    */

    @Test
    public void testBenchRandomHeapsort()
    {
        for (int i = 0; i < ITERATIONS; i++) {
            Object[] a = Arrays.copyOf(bigRandom, bigRandom.length);
            Sorting.heapsort(a, new IntComparator());
        }
    }
    ...
    */
    ...
    @Test
    public void testBenchReverseHeapsort()
    {
        for (int i = 0; i < ITERATIONS; i++) {
            Object[] a = reverseArray(BIG_ARRAY);
            Sorting.heapsort(a, new IntComparator());
    ...
    @Test
    public void testBenchSequentialHeapsort()
    {
        for (int i = 0; i < ITERATIONS; i++) {
            Object[] a = forwardArray(BIG_ARRAY);
            Sorting.heapsort(a, new IntComparator());
